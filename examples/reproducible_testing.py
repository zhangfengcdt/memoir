...
async def main():
    ...
    try:
        ...
        test_timeline.append((baseline_commit, baseline_time, "📋 Baseline test state created", "baseline"))
        ...
        test_timeline.append((test1_branch, test1_time, "🧪 Test 1: Beginner user scenario", "test"))
        ...
        test_timeline.append((test2_branch, test2_time, "🧪 Test 2: Expert user scenario", "test"))
        ...
        test_timeline.append((test3_branch, test3_time, "🧪 Test 3: Mixed experience scenario", "test"))
        ...
        has_beginner = "new to programming" in str(beginner_check) if beginner_check else False
        ...
        print(f"  ✅ Test scenarios are completely isolated")
        ...
        test_timeline.append((rerun_branch, rerun_time, "🔄 Test 1 rerun: Beginner scenario", "rerun"))
        ...
        print("=" * 65)
        for i, (branch_id, timestamp, description, test_type) in enumerate(reversed(test_timeline), 1):
