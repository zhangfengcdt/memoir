...
#   The slug is Codex-friendly: take the absolute path and replace '/' and '.'
#   with '-'.
#
#   /Users/feng/github/memoir         -> ~/.memoir/-Users-feng-github-memoir
#   /Users/feng/.codex-mem/sessions   -> ~/.memoir/-Users-feng--codex-mem-sessions
#
...
# helper snippets and the memory-recall skill resolve to the same store
...
# Slug = absolute path with '/' and '.' replaced by '-'. This keeps store names
# inspectable by eye while avoiding nested directories.
